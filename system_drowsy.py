...
with open("file_running.text","w") as write_data:
    write_data.write("/home/pi/Desktop/final_drowsiness/system_drowsy.py")
...
while True:
    ...
    with open("/home/pi/Desktop/final_drowsiness/reading_data.text","r") as reading_data:
        data_for_reading=reading_data.read()
        data_for_reading=int(data_for_reading)
        print(data_for_reading)

    if data_for_reading==1:
        sys.exit()
    if data_for_reading==0:
        print("liveoff")
        frame=cap.read()
